...
public class CalculadoraGaucho extends JFrame {
    ...
    public CalculadoraGaucho() {
        ...
        pantalla.setHorizontalAlignment(SwingConstants.RIGHT); // prpiedad para alinear el textico a la derecha
        ...
        String[] botones = {
                "AC", "/", "x", "DEL", // AC borra todo y DEL borra solo el ultimo num
                "7", "8", "9", "-",
                "4", "5", "6", "+",
                "1", "2", "3", "=",
        ...
        for (String texto : botones) {
            ...
            // aplica estilos
            if (texto.equals("AC") || texto.equals("=") || texto.equals("+") || texto.equals("-") || texto.equals("x") || texto.equals("/") || texto.equals("DEL")  )  {
